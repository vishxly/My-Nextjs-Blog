  ...
  return (
    <main className="flex justify-center dark:bg-black">
      <section className="flex flex-col gap-5 px-4 sm:px-8 md:px-16 py-6 sm:py-8 md:py-10 w-full max-w-[800px] dark:text-white">
        ...
        <h1 className="text-xl font-bold sm:text-2xl dark:text-white">{post?.title}</h1>
        <img className="object-cover w-full rounded-lg" src={post?.imageURL} alt="" />
...
async function AuthorCard({ authorId }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <img className="object-cover w-6 h-6 rounded-full" src={author?.photoURL} alt="" />
...
async function CategoryCard({ categoryId }) {
  ...
  return (
    <div className="flex">
      <div className="flex items-center gap-2 px-2 py-1 bg-white border rounded-full bg-opacity-60 dark:bg-gray-800 dark:bg-opacity-60 dark:border-gray-700">
        <img className="object-cover w-4 h-4 rounded-full" src={category?.iconURL} alt="" />
